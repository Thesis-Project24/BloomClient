...
{/* 
      ...
      <Button
        onPress={() => {
          ...
          console.log({ duration, pause, chosenDateStart, chosenDateEnd }, 'before mutation')
          mutation.mutate([{ doctorId:1,duration:Number(duration), pause:Number(pause), startingTime:chosenDateStart, endingTime:chosenDateEnd }]);
        }}
        title="set window"
      ></Button>
    </View>
