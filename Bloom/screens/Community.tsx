...
const Community = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      />
      <Button title="Create New Post" onPress={() => {/* Navigate to New Post Screen */}} />
    </View>
  );
};
